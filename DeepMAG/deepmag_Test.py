...
data_dir = '\\\\vibe15\\PublicAll\\damcduff\\RPPG\\DeepMagCode\\videos\\baby2.mat'

model_dir = '\\\\vibe15\\PublicAll\\damcduff\\RPPG\\DeepMagCode\\handTest\\model47.h5'
...
#%%
Xnew = np.zeros((298, 123, 123, 4),dtype=np.float32)
for i in range(298):
    img = dXsub[[i],:,:,:]
...
scipy.io.savemat(args.video[:-4]+'Mag.mat', mdict={'Xnew': Xnew})